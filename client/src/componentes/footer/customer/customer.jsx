  ...
  return (
    <div>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            Utilizamos una variedad de tejidos de alta calidad, como poliéster,
            nylon y spandex, que ofrecen transpirabilidad, elasticidad y
            resistencia para una experiencia cómoda durante tus actividades
            físicas.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            Recomendamos lavar las prendas a mano o en ciclo suave con agua fría
            para preservar la calidad de los tejidos y los colores. Evita el uso
            de suavizantes y secadoras, ya que pueden afectar la elasticidad y
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            Sí, realizamos envíos internacionales a varios países. Los detalles
            de envío, costos y tiempos estimados se proporcionan durante el
            proceso de compra.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            Sí, garantizamos la seguridad de tus datos. Aceptamos varios métodos
            de pago seguros, como tarjetas de crédito y PayPal, para facilitar
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography>¿Ofrecen descuentos o promociones especiales?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            Puedes ponerte en contacto con nuestro equipo de servicio al cliente
            a través de nuestra página de contacto, donde encontrarás un
            formulario de consulta. Estamos aquí para ayudarte con cualquier
