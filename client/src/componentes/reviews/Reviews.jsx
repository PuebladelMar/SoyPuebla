    ...
    return(
        <div>
            ...
            >
                ...
                <SwiperSlide className='swiperSlide'>
                    <img className='imagen' src='/src/assets/images/imagesReseñas/mujer2.png' alt="Imagen 2" />
                    <div className="review">
                    <h2 className='th3'>Nombre:</h2>
                ...
                <SwiperSlide className='swiperSlide'>
                    <img className='imagen' src='/src/assets/images/imagesReseñas/mujer3.jpeg' alt="Imagen 3" />
                    <div className="review">
                    <h2 className='th3'>Nombre:</h2>
